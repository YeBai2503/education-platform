...
public class JoinClassServiceImpl extends ServiceImpl<JoinClassMapper, JoinClass> implements IJoinClassService {
    ...
    public Integer getCourseStudentCount(Integer courseId) {
        return joinClassMapper.getCourseStudentCount(courseId);
    }
     ...
     */
    @Override
    public List<JoinClass> getStudentAllJoinClasses(Integer studentId) {
        LambdaQueryWrapper<JoinClass> queryWrapper = new LambdaQueryWrapper<>();
        queryWrapper.eq(JoinClass::getStudentId, studentId);
