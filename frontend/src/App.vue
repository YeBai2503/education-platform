...
// 登录弹窗相关状态
const loginModalVisible = computed(() => authService.loginModalVisible.value);
const redirectPath = computed(() => authService.redirectPath.value);

// 更新登录弹窗可见状态
const updateLoginModalVisible = (val) => {
  authService.loginModalVisible.value = val;
};
