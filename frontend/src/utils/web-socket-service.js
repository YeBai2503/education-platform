...
export default class SocketService {
    ...
    connect() {
        ...
        let ip = import.meta.env.VITE_API_HOST_IP;
        let message_path = import.meta.env.VITE_MESSAGE_API_URL;
        this.ws = new WebSocket(`ws://${ip}${message_path}?token=${this.store.token}`);
        // 连接成功的事件
        this.ws.onopen = () => {
